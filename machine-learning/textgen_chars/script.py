...
class OneStep(tf.keras.Model):
  ...
  def generate_one_step(self, inputs, states1=None, states2=None):
    ...
    predicted_logits, states1, states2 =  self.model(inputs=input_ids, states1=states1, states2=states2,
                                          return_state=True)
...
for n in range(1000):
  next_char, states1, states2 = one_step_model.one_step_reloaded(next_char, states1=states1, states2=states2)
  result.append(next_char)
